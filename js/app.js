...
const PLATFORMS = {
  mac: {
    key: "ctaMac",
    url: "https://github.com/m-1226/mushaffar-website/releases/download/v1.5.0/Mushaffar.dmg",
  ...
  windows: {
    key: "ctaWindows",
    url: "https://github.com/m-1226/mushaffar-website/releases/download/v1.5.0/Mushaffar_Windows.zip",
  ...
  linux: {
    key: "ctaLinux",
    url: "https://github.com/m-1226/mushaffar-website/releases/download/v1.5.0/Mushaffar-Linux.tar.gz",
